...
slug: 2025/04/29/how-i-beat-procrastination-on-my-side-project
---
...
- **Pick a System:** Use a Project Manager App, a simple to-do list, or even sticky notes. It doesn't matter _what_ you use, just that you have _a_ system to track what needs doing. Writing it down makes the plan clearer and less overwhelming.

**2. Define a Clear MVP**

Trying to do too much kills side projects. A clear Minimum Viable Product keeps you on track.

- **Focus on the Core:** What's the absolute minimum needed to get a first working version out? Put off _all_ the extra features until that core is done. Make sure your tasks aim straight for the MVP.
